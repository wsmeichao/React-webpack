...
ComponentTool.bind = function(context,type,callback){
	let contextResult;
...
ComponentTool.unbind = function(context,type,callback){
 ...
 * @returns
 */
ComponentTool.localItem = function (key, value) {
 ...
 * @returns
 */
ComponentTool.removeLocalItem = function (key) {
    if (key) {
 ...
 * @return arr 会改变arr的值
 */
ComponentTool.ArrayConcat = function(arr,...list){
    list.forEach((item)=>{
